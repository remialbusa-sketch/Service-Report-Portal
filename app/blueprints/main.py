...
def submit():
    try:
        ...
        form_data = {
            ...
            "COL_SERVICE_START": request.form.get("service_start") or None,
            "COL_SERVICE_END": request.form.get("service_end") or None,
            "COL_LOGIN_DATE": request.form.get("login_date") or None,
            "COL_LOGOUT_DATE": request.form.get("logout_date") or None,
